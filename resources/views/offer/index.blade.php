                   ...
                   <div class="card card-default">
                       ...
                       <table class="table-fixed border-collapse border border-green-800" dir="rtl" >
                            ...
                            @foreach($offers as $offer)
                                ...
                                <td>  <a href="{{route('details.show',$offer->id)}}" class="bg-blue-500 text-white rounded font-medium w-full">التفاصيل</a></td>
                                <td>  <a href="{{route('offers.edit',$offer)}}" class="bg-blue-500 text-white rounded font-medium w-full">تعديل</a></td>
                                    <td>
