            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 bg-white border-b border-gray-200">
                   <div class="card card-default">
                       <div class="card-header flex justify-center">أضافة العروض
                       </div>
                       ...
                       <div class="w-3/12 bg-white p-6 rounded-lg">
                           ...
                           <div class="mb-4">
                               ...
                               <div class="mb-4">
                                <x-input  type="text" name="type_ar"
                                       class="bg-gray-100 border-2 w-full p-4 rounded-lg"
                                       placeholder="أدخال النوع بالعربية" />
                           </div>
                               <div class="mb-4">
                                   <x-input  type="text" name="type_en"
                                          class="bg-gray-100 border-2 w-full p-4 rounded-lg"
                                          placeholder="أدخال النوع بالانجليزية" />
                               </div>
                               <div class="mb-4">
                                   <x-input  type="text" name="type_es"
                                          class="bg-gray-100 border-2 w-full p-4 rounded-lg"
                           ...
                           <div class="mb-4">
                             ...
                             text-white rounded font-medium w-full">أدخال</x-button>
                             </div>
                        </form>
                       </div>
                       </div>
